...
#This plugins subclasses my lightfield, shutters and chopper plugins 
class DAQ_1DViewer_tadetector(DAQ_0DViewer_chopper, DAQ_0DViewer_shutters, DAQ_1DViewer_lightfield):
    ...
    def __init__(self, parent=None, params_state=None):
        DAQ_0DViewer_chopper.__init__(self, parent, params_state)
        DAQ_0DViewer_shutters.__init__(self,parent, params_state)
        DAQ_1DViewer_lightfield.__init__(self, parent, params_state)
